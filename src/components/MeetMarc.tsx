  ...
  return <section className="w-full bg-brand-warm section-spacing">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-32">
          ...
          return <div key={card.id} className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
                <div className="lg:w-1/2">
                  <img src={card.image_url} alt={card.title} className="w-full h-auto object-cover rounded sm:hidden" loading="lazy" decoding="async" />
