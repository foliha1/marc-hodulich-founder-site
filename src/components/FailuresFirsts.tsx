    ...
    <section className="w-full bg-brand-warm py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="animate-slide-up">
          <h2 className="display-title text-brand-ink mb-6">FAILURES, FIRSTS, AND FOUNDATIONS</h2>
          <p className="body-text text-brand-ink-sub max-w-4xl leading-relaxed mb-16">
